...
using TextReader.Extensions.Predicates;
...
namespace TextReader.Extensions
{
    ...
    public static class DependencyObjectExtensions
    {
        ...
        public static FrameworkElement FindDescendant(this DependencyObject element, string name, StringComparison comparisonType = StringComparison.Ordinal)
        {
            ...
            return element.FindDescendant<FrameworkElement, PredicateByName>(ref predicateByName);
        }
            ...
            where T : DependencyObject
        {
            ...
            return element.FindDescendant<T, PredicateByAny<T>>(ref predicateByAny);
        }
        ...
        public static DependencyObject FindDescendant(this DependencyObject element, Type type)
        {
            ...
            return element.FindDescendant<DependencyObject, PredicateByType>(ref predicateByType);
        }
            ...
            where T : DependencyObject
        {
            ...
            return element.FindDescendant<T, PredicateByFunc<T>>(ref predicateByFunc);
        }
            ...
            where T : DependencyObject
        {
            ...
            return element.FindDescendant<T, PredicateByFunc<T, TState>>(ref predicateByFunc);
        }
        ...
        public static FrameworkElement FindDescendantOrSelf(this DependencyObject element, string name, StringComparison comparisonType = StringComparison.Ordinal)
        {
            return element is FrameworkElement result && name.Equals(result.Name, comparisonType)
                ? result
                : element.FindDescendant(name, comparisonType);
        }
        ...
        public static T FindDescendantOrSelf<T>(this DependencyObject element)
            where T : DependencyObject
        {
            return element is T result ? result : element.FindDescendant<T>();
        }
        ...
        {
            return element.GetType() == type ? element : element.FindDescendant(type);
        }
        ...
        public static T FindDescendantOrSelf<T>(this DependencyObject element, Func<T, bool> predicate)
            where T : DependencyObject
        {
            return element is T result && predicate(result) ? result : element.FindDescendant(predicate);
        }
        ...
        public static T FindDescendantOrSelf<T, TState>(this DependencyObject element, TState state, Func<T, TState, bool> predicate)
            where T : DependencyObject
        {
            return element is T result && predicate(result, state) ? result : element.FindDescendant(state, predicate);
        }
        ...
        public static FrameworkElement FindAscendant(this DependencyObject element, string name, StringComparison comparisonType = StringComparison.Ordinal)
        {
            ...
            return element.FindAscendant<FrameworkElement, PredicateByName>(ref predicateByName);
        }
            ...
            where T : DependencyObject
        {
            ...
            return element.FindAscendant<T, PredicateByAny<T>>(ref predicateByAny);
        }
        ...
        public static DependencyObject FindAscendant(this DependencyObject element, Type type)
        {
            ...
            return element.FindAscendant<DependencyObject, PredicateByType>(ref predicateByType);
        }
            ...
            where T : DependencyObject
        {
            ...
            return element.FindAscendant<T, PredicateByFunc<T>>(ref predicateByFunc);
        }
            ...
            where T : DependencyObject
        {
            ...
            return element.FindAscendant<T, PredicateByFunc<T, TState>>(ref predicateByFunc);
        }
        ...
        public static FrameworkElement FindAscendantOrSelf(this DependencyObject element, string name, StringComparison comparisonType = StringComparison.Ordinal)
        {
            return element is FrameworkElement result && name.Equals(result.Name, comparisonType)
                ? result
                : element.FindAscendant(name, comparisonType);
        }
        ...
        public static T FindAscendantOrSelf<T>(this DependencyObject element)
            where T : DependencyObject
        {
            return element is T result ? result : element.FindAscendant<T>();
        }
        ...
        {
            return element.GetType() == type ? element : element.FindAscendant(type);
        }
        ...
        public static T FindAscendantOrSelf<T>(this DependencyObject element, Func<T, bool> predicate)
            where T : DependencyObject
        {
            return element is T result && predicate(result) ? result : element.FindAscendant(predicate);
        }
        ...
        public static T FindAscendantOrSelf<T, TState>(this DependencyObject element, TState state, Func<T, TState, bool> predicate)
            where T : DependencyObject
        {
            return element is T result && predicate(result, state) ? result : element.FindAscendant(state, predicate);
        }
